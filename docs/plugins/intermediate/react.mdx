...
One thing to keep in mind going forward: without [bundling](./bundling.mdx), you cannot use JSX style react components in a plugin. For that reason, this section will be done without any JSX.
...
<Tabs className="code-tabs" groupId="reactStyle">
<TabItem value="Class">
...
```js showLineNumbers title="MyComponentDemo.plugin.js"
/**
