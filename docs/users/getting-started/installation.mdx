...
### Manually updating BetterDiscord

##### 1. Enter the BetterDiscord directory
```bash
cd BetterDiscord
```

#### 2. Pull an up-to-date version of the Git repository
```bash
git pull
```

#### 3. Build BetterDiscord
```bash
pnpm build
```

#### 4. Reinject to Discord
