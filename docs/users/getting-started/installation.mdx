...
<TabItem value="stable"><CodeBlock language="bash">npm run inject</CodeBlock></TabItem>
<TabItem value="canary"><CodeBlock language="bash">npm run inject canary</CodeBlock></TabItem>
<TabItem value="ptb"><CodeBlock language="bash">npm run inject ptb</CodeBlock></TabItem>
</Tabs>